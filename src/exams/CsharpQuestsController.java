 ...
 * @author EVELYN
 */
public class CsharpQuestsController implements Initializable{
...
//        String radbtn = rad.getText();
    ...
    private void next(ActionEvent event) throws SQLException {   
        ...
        String query = "update csharp set studans ='"+selectedAnswer+"' where questid = '"+questNum+"' ";   
    ...
    private void prev(ActionEvent event) throws SQLException {
        String selectedAnswer = "" ;
        String query = "update csharp set studans ='"+selectedAnswer+"' where questid = '"+qid+"' ";   
...
//        if(questNum >9){
        ...
        shouldThreadStop = true;
            ...
            // calculate scores
            try{
                ResultSet rs = dbt.readFromDB("select * from csharp") ;
                while(rs.next()){
                    String studAns = rs.getString("answers") ;
                    String corAns = rs.getString("studans") ;
